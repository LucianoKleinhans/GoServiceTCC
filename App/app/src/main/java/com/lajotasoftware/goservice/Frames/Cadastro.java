    ...
    private void initializeComponentsCadastro() {
        ...
        btn_gravar_usuario.setOnClickListener(view -> {
            ...
            if (CPF != null) {
                ...
                }else{Toast.makeText(Cadastro.this, "CPF inválido!", Toast.LENGTH_SHORT).show();}
                if (CNPJ != null) {
                    if (function.isCNPJ(CNPJ)) {
                        Boolean validCNPJ = true;
                    }else{Toast.makeText(Cadastro.this, "CNPJ inválido!", Toast.LENGTH_SHORT).show();}
                    if (!(primeiroNome.equals(""))) {
                        if (!(segundoNome.equals(""))) {
                            if ((CNPJ.equals("")) && (CPF.equals(""))) {
